  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <select class="form-control" name="fakultas" id="fakultas">
          ...
          <option value="sipil" <?php if($fakultas == "sipil") echo "selected"?>>sipil</option>
          ...
          <option value="bioteknologi" <?php if($fakultas == "bioteknologi") echo "selected"?>>bioteknologi</option>
      </select>
    </div>
  </div>
  <div class="col-12">
